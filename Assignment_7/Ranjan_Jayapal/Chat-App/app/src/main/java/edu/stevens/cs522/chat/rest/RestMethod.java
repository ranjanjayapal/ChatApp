...
public class RestMethod {
    ...
    public Response perform(RegisterRequest request) {
        Log.e(TAG,"performing request started");
        URL url = registerURL(request);
        Log.e(TAG,"URL Registered");
        if (url == null) {
        ...
        try {
            ...
            Log.e(TAG,"After init connection before executing oneway request");
   ...
   /* public Response perform(RegisterRequest request) {
        ...
        try {
            ...
            response=request.getResponse(conn);
            ...
            if (response.httpResponseCode == 201) {
                ...
                jr.close();
            }else if(response.httpResponseCode == 400){
                response = null;
    ...
    public StreamingResponse perform(SynchronizeRequest request, StreamingOutput out) throws IOException {
        ...
        try {
            Log.e(RestMethod.class.getCanonicalName(), "performing StreamingResponse");
            getWakeLock(context, SERVICE_DURATION);
            initConnection(url, request);
    ...
    private Response executeRequest(String method, Request request) throws SocketTimeoutException, IOException {
        ...
        connection.setRequestProperty("X-latitude", "53.77305");
        connection.setRequestProperty("X-longitude", "54.844726");
