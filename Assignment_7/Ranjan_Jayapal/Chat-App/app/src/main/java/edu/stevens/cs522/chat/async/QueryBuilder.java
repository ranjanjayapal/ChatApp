...
public class QueryBuilder<T> implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        if (id == loaderId) {
            Log.e(QueryBuilder.class.getCanonicalName(),"LoaderId-:" + id);
            ...
            switch (id) {
                ...
                case MessageManager.LOADER_ID:
                    projection = new String[]{
                            MessageContract.ID,
                            MessageContract.SEQUENCE_NUMBER,
                            MessageContract.MESSAGE_TEXT,
                            MessageContract.CHAT_ROOM,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        for(String x:data.getColumnNames())
            Log.e(QueryBuilder.class.getCanonicalName(), x);
