...
public class ChatProvider extends ContentProvider {
    ...
    public static class DbHelper extends SQLiteOpenHelper {
        ...
        private static final String DATABASE_CREATE1 = "CREATE TABLE " + PEERS_TABLE + " (" + NAME + " text primary key," + TIMESTAMP + " text," + LATITUDE + " text," + LONGITUDE + " text, _id text );";

        private static final String DATABASE_CREATE2 = "CREATE TABLE " + MESSAGES_TABLE + " (" + MESSAGE_ID + " integer primary key autoincrement," +
                SEQUENCE_NUMBER + " integer," + MESSAGE_TEXT + " text," + CHAT_ROOM + " text," + TIMESTAMP + " text," + LATITUDE + " text," + LONGITUDE + " text," + SENDER + " text," + PEER_FK + " text, foreign key (" + PEER_FK + ") references " + PEERS_TABLE +
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatcher.match(uri)) {
            case MESSAGES_ALL_ROWS:
                ...
                // Make sure to notify any observersrowId = db.insert(MESSAGES_TABLE, null, values);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case PEERS_SINGLE_ROW:
                ...
                builder.appendWhere(PeerContract.NAME + " = " + PeerContract.getName(uri));
                break;
            default:
                throw new IllegalStateException("insert: bad case");
        }
